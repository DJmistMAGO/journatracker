...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('article-management.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <select class="form-select" id="category" name="category" required>
                            ...
                            <option value="Editorial" {{ old('category') == 'Editorial' ? 'selected' : '' }}>Editorial
                            </option>
                            <option value="Sports" {{ old('category') == 'Sports' ? 'selected' : '' }}>Sports</option>
                            <option value="Column" {{ old('category') == 'Column' ? 'selected' : '' }}>Column</option>
                            <option value="Sci-Tech" {{ old('category') == 'Sci-Tech' ? 'selected' : '' }}>Sci-Tech
                            </option>
                        </select>
                    </div>
