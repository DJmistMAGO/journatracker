                    ...
                    @forelse($items as $item)
                        <tr>
                            ...
                            <td class="text-nowrap">
                                {{-- View --}}
                                <a href="{{ route('archive.show', ['id' => $item->id, 'type' => strtolower($item->type)]) }}"
            ...
            @forelse($items as $item)
                <div class="card mb-4 mt-3 shadow-lg">
                    <div class="card-body d-flex flex-column gap-2">
                        ...
                        <p class="mb-0"><strong>Date Published:</strong>
                        ...
                        <div class="d-flex gap-2 mt-2 flex-wrap">
                            ...
                            @unlessrole('student')
                                ...
                                @if ($item->status === 'Published')
                                    ...
                                    {{-- Mobile modal --}}
                                    <div class="modal fade" id="unpublishModalMobile-{{ $item->id }}" tabindex="-1"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <form method="POST"
