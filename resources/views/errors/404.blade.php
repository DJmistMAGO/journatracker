...
.composition {
  ...
  background-image: linear-gradient(to left, #008533, #00A23F);
...
.shelf__side_front {
  ...
  background-image: linear-gradient(160deg, #84fff2, #00A23F);
...
.shelf__side_right {
  ...
  background-image: linear-gradient(0deg, #006b2d, #008533);
...
.shadow {
  ...
  background-image: linear-gradient(to right, rgba(0, 70, 30, 0), rgba(0, 70, 30, 0.8) 65%, rgba(0, 70, 30, 1));
}
...
.btn-home {
  ...
  padding: 14px 32px;
  background: linear-gradient(135deg, #00A23F 0%, #008533 100%);
  color: white;
