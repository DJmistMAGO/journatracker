...
<!-- Main Content + Sidebar -->
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-sm-3">
            <div class="card">
                <img src="https://picsum.photos/1200/" class="card-img-top" alt="..." height="150">
                <div class="card-body">
            ...
            <div class="col-sm-3">
            <div class="card">
                <img src="https://picsum.photos/1300/" class="card-img-top" alt="..." height="150">
                <div class="card-body">
            ...
            <div class="col-sm-3">
            <div class="card">
                <img src="https://picsum.photos/1400/" class="card-img-top" alt="..." height="150">
                <div class="card-body">
            ...
            <div class="col-sm-3">
            <div class="card">
                <img src="https://picsum.photos/1500/" class="card-img-top" alt="..." height="150">
                <div class="card-body">
    ...
    <div class="row mt-4">
        ...
        <div class="row">
            <div class="col-sm-3">
            <div class="card">
                <img src="https://picsum.photos/1600/" class="card-img-top" alt="..." height="150">
                <div class="card-body">
                <a href="#"><h5 class="card-title">Israel launches strike on target in Qatar</h5></a>
            ...
            <div class="col-sm-3">
            <div class="card">
                <img src="https://picsum.photos/1700/" class="card-img-top" alt="..." height="150">
                <div class="card-body">
                <a href="#"><h5 class="card-title">Kanlaon Volcano emits ash; Alert Level 2 remains</h5></a>
                </div>
            </div>
            ...
            <div class="col-sm-3">
            <div class="card">
                <img src="https://picsum.photos/1800/" class="card-img-top" alt="..." height="150">
                <div class="card-body">
                <a href="#"><h5 class="card-title">Jinggoy Estrada, Joel Villanueva in flood control</h5></a>
                {{-- <p class="card-text">Some quick example text to build on.</p> --}}
                {{-- <a href="#" class="btn btn-primary">Read More</a> --}}
            ...
            <div class="col-sm-3">
            <div class="card">
                <img src="https://picsum.photos/1900/" class="card-img-top" alt="..." height="150">
                <div class="card-body">
                <a href="#"><h5 class="card-title">Jinggoy Estrada denies links to flood control projects</h5></a>
                {{-- <p class="card-text">Some quick example text to build on.</p> --}}
                {{-- <a href="#" class="btn btn-primary">Read More</a> --}}
    ...
    <div class="row mt-4">
        ...
        <div class="row">
            <div class="col-sm-3">
            <div class="card">
                <img src="https://picsum.photos/1250/" class="card-img-top" alt="..." height="150">
                <div class="card-body">
                <a href="#"><h5 class="card-title">Israel launches strike on target in Qatar</h5></a>
                {{-- <p class="card-text">Some quick example text to build on.</p> --}}
                {{-- <a href="#" class="btn btn-primary">Read More</a> --}}
            ...
            <div class="col-sm-3">
            <div class="card">
                <img src="https://picsum.photos/1260/" class="card-img-top" alt="..." height="150">
                <div class="card-body">
                <a href="#"><h5 class="card-title">Kanlaon Volcano emits ash; Alert Level 2 remains</h5></a>
                </div>
            </div>
            ...
            <div class="col-sm-3">
            <div class="card">
                <img src="https://picsum.photos/1270/" class="card-img-top" alt="..." height="150">
                <div class="card-body">
                <a href="#"><h5 class="card-title">Jinggoy Estrada, Joel Villanueva in flood control</h5></a>
                {{-- <p class="card-text">Some quick example text to build on.</p> --}}
                {{-- <a href="#" class="btn btn-primary">Read More</a> --}}
            ...
            <div class="col-sm-3">
            <div class="card">
                <img src="https://picsum.photos/1280/" class="card-img-top" alt="..." height="150">
                <div class="card-body">
                <a href="#"><h5 class="card-title">Jinggoy Estrada denies links to flood control projects</h5></a>
                {{-- <p class="card-text">Some quick example text to build on.</p> --}}
                {{-- <a href="#" class="btn btn-primary">Read More</a> --}}
